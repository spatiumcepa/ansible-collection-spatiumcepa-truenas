...
DOCUMENTATION = """
module: truenas_api_service

short_description: Manage TrueNAS Services

description:
  - Manage TrueNAS Services via REST API
...
options:
  ...
  enable:
    ...
    type: bool
  running:
    description: Should service be currently running
    type: bool
"""
...
def main():
    module = AnsibleModule(
        argument_spec=dict(
            ...
            enable={'type': 'str', 'type': 'bool'},
            running={'type': 'str', 'type': 'bool'},
        ),
    ...
    try:
        ...
        running = module.params['running']

        response = service_resource.service_state(name, enable, running)
